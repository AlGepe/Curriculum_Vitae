...
\cventry{July 2018 - October 2022)}{Web content writer}{Omni Calculator, Krakow}{Calculator creation and onboarding}{\newline Creating new online calculators (including text write-ups and calcualtor coding) as well as creating documentation and onboarding workshops for new hires}{}{}

\cventry{October 2020 - October 2022)}{Audiovisual manager}{Omni Calculator, Krakow}{Managing a small team producing audiovisual content for Omni Calculator, mostly aimed at Youtube.}{Main tasks icluded hosting videos, shooting, script-writing, video editing...}{}

\cventry{October 2022 - Present)}{Marketing specialist}{Omni Calculator, Krakow}{Creating and running marketing campaings for Omni Calculator including cold-mailing campaings (link building) as well as social media ad campaings}{}
