...
\cventry{2010-2017}{Degree in Physics}{Universidad de Cantabria}{Santander}{\newline\underline{\textit{Final Grade}} Spanish: 7.45/10 || GPA: 3.30 / 4}{}
...
\begin{itemize}%
	...
	\item Bachelor's thesis: \newline{}
		...
		\cvitem{PR Paper}{\textit{[Awaiting approval]}} 
\end{itemize}
...
\vspace{-30pt}
	\begin{addmargin}[6.5em]{0em}% 1em left, 2em right
		\item[] \textbf{MSOffice, LibreOffice, \LaTeX}
		\item  Intermediate/Advance and fluent usage of command line interface as well as remote work (e.g.: ssh, sshfs...)
	\end{itemize}
\end{addmargin}% 1em left, 2em right
