...
\address{c/ Macias Picavea 14 8D}{39003 Santander}{Spain}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\cventry{July 2018 - October 2022)}{Web content writer}{Omni Calculator, Krakow}{Calculator creation and on boarding}{\newline Creating new online calculators (including text write-ups and calculator coding) as well as creating documentation and onboarding workshops for new hires}{}{}

\cventry{October 2020 - October 2022)}{Audiovisual manager}{Omni Calculator, Krakow}{Managing a small team producing audiovisual content for Omni Calculator, mostly aimed at YouTube.}{Main tasks included hosting videos, shooting, script-writing, video editing...}{}

\cventry{October 2022 - Present)}{Marketing specialist}{Omni Calculator, Krakow}{Creating and running marketing campaigns for Omni Calculator including cold-mailing campaigns (link building) as well as social media ad campaigns}{}

\cventry{October 2023 - Present)}{Translation specialist}{Omni Calculator, Krakow}{Translating science communications texts from English into Spanish}{}
...
\vspace{-30pt}
	\begin{addmargin}[6.5em]{0em}% 1em left, 2em right
		...
		\item  Intermediate level with experience mainly in Latex and Excel
	\end{itemize}
\end{addmargin}% 1em left, 2em right
...
\cvlistitem{\href{https://www.elespanol.com/autor/alvaro_diez/}{Published articles on El Español}}
%\end{vplace}
