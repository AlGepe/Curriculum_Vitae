...
\label{sub:laboral}
\cventry{June-September (2015)}{Internship at CERN}{CERN, Geneva}{Worked as part of the PH-DD-SSD group at CERN }{Working as main developer of \href{https://github.com/IFCA-HEP/TRACS}{TRACS}, a fast simulator for irradiated silicon detectors in C++}{Summer Student Program}{}
...
\cventry{2013-current}{Founder and member of the Physics Mentor Group}{Santander}{}{\newline The Physics Mentor Group is a group founder by students and aimed to help students in their first and second year at university}{The group has collaborated with IFCA and UC in events like "Reasearcher's nite" and also organized their own.}%
